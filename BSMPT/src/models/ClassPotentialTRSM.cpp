...
void Class_Potential_TRSM::set_gen(const std::vector<double> &par)
{
  ...
  ls = (pow(m2,2)*pow(cos(a12),2) + pow(m1,2)*pow(sin(a12),2))/(2.*pow(vs,2)); 
  lphis = ((-pow(m1,2) + pow(m2,2))*cos(a12)*sin(a12))/(SMConstants.C_vev0*vs); 
  mxSq = pow(m3,2) - (lphix*pow(SMConstants.C_vev0,2))/2. - (lsx*pow(vs,2))/2.; 
  mphiSq = (-(pow(m1,2)*pow(cos(a12),2)) + ((pow(m1,2) - pow(m2,2))*vs*cos(a12)*sin(a12))/SMConstants.C_vev0 - pow(m2,2)*pow(sin(a12),2))/2.; 
  msSq = (-(pow(m2,2)*pow(cos(a12),2)) + ((pow(m1,2) - pow(m2,2))*SMConstants.C_vev0*cos(a12)*sin(a12))/vs - pow(m1,2)*pow(sin(a12),2))/2.; 
...
void Class_Potential_TRSM::set_CT_Pot_Par(const std::vector<double> &par)
{
  ...
  Curvature_Higgs_CT_L2[4][4] = dmxSq;
  Curvature_Higgs_CT_L2[5][5] = dmsSq;
  ...
  Curvature_Higgs_CT_L4[0][0][4][4] = dlphix;
  Curvature_Higgs_CT_L4[0][0][5][5] = dlphis;
  ...
  Curvature_Higgs_CT_L4[0][4][0][4] = dlphix;
  Curvature_Higgs_CT_L4[0][4][4][0] = dlphix;
  Curvature_Higgs_CT_L4[0][5][0][5] = dlphis;
  Curvature_Higgs_CT_L4[0][5][5][0] = dlphis;
  ...
  Curvature_Higgs_CT_L4[1][1][4][4] = dlphix;
  Curvature_Higgs_CT_L4[1][1][5][5] = dlphis;
  ...
  Curvature_Higgs_CT_L4[1][4][1][4] = dlphix;
  Curvature_Higgs_CT_L4[1][4][4][1] = dlphix;
  Curvature_Higgs_CT_L4[1][5][1][5] = dlphis;
  Curvature_Higgs_CT_L4[1][5][5][1] = dlphis;
  ...
  Curvature_Higgs_CT_L4[2][2][4][4] = dlphix;
  Curvature_Higgs_CT_L4[2][2][5][5] = dlphis;
  Curvature_Higgs_CT_L4[2][3][2][3] = 2*dlphi;
  Curvature_Higgs_CT_L4[2][3][3][2] = 2*dlphi;
  Curvature_Higgs_CT_L4[2][4][2][4] = dlphix;
  Curvature_Higgs_CT_L4[2][4][4][2] = dlphix;
  Curvature_Higgs_CT_L4[2][5][2][5] = dlphis;
  Curvature_Higgs_CT_L4[2][5][5][2] = dlphis;
  ...
  Curvature_Higgs_CT_L4[3][3][4][4] = dlphix;
  Curvature_Higgs_CT_L4[3][3][5][5] = dlphis;
  Curvature_Higgs_CT_L4[3][4][3][4] = dlphix;
  Curvature_Higgs_CT_L4[3][4][4][3] = dlphix;
  Curvature_Higgs_CT_L4[3][5][3][5] = dlphis;
  Curvature_Higgs_CT_L4[3][5][5][3] = dlphis;
  Curvature_Higgs_CT_L4[4][0][0][4] = dlphix;
  Curvature_Higgs_CT_L4[4][0][4][0] = dlphix;
  Curvature_Higgs_CT_L4[4][1][1][4] = dlphix;
  Curvature_Higgs_CT_L4[4][1][4][1] = dlphix;
  Curvature_Higgs_CT_L4[4][2][2][4] = dlphix;
  Curvature_Higgs_CT_L4[4][2][4][2] = dlphix;
  Curvature_Higgs_CT_L4[4][3][3][4] = dlphix;
  Curvature_Higgs_CT_L4[4][3][4][3] = dlphix;
  Curvature_Higgs_CT_L4[4][4][0][0] = dlphix;
  Curvature_Higgs_CT_L4[4][4][1][1] = dlphix;
  Curvature_Higgs_CT_L4[4][4][2][2] = dlphix;
  Curvature_Higgs_CT_L4[4][4][3][3] = dlphix;
  Curvature_Higgs_CT_L4[4][4][4][4] = 6*dlx;
  Curvature_Higgs_CT_L4[4][4][5][5] = dlsx;
  Curvature_Higgs_CT_L4[4][5][4][5] = dlsx;
  Curvature_Higgs_CT_L4[4][5][5][4] = dlsx;
  Curvature_Higgs_CT_L4[5][0][0][5] = dlphis;
  Curvature_Higgs_CT_L4[5][0][5][0] = dlphis;
  Curvature_Higgs_CT_L4[5][1][1][5] = dlphis;
  Curvature_Higgs_CT_L4[5][1][5][1] = dlphis;
  Curvature_Higgs_CT_L4[5][2][2][5] = dlphis;
  Curvature_Higgs_CT_L4[5][2][5][2] = dlphis;
  Curvature_Higgs_CT_L4[5][3][3][5] = dlphis;
  Curvature_Higgs_CT_L4[5][3][5][3] = dlphis;
  Curvature_Higgs_CT_L4[5][4][4][5] = dlsx;
  Curvature_Higgs_CT_L4[5][4][5][4] = dlsx;
  Curvature_Higgs_CT_L4[5][5][0][0] = dlphis;
  Curvature_Higgs_CT_L4[5][5][1][1] = dlphis;
  Curvature_Higgs_CT_L4[5][5][2][2] = dlphis;
  Curvature_Higgs_CT_L4[5][5][3][3] = dlphis;
  Curvature_Higgs_CT_L4[5][5][4][4] = dlsx;
  Curvature_Higgs_CT_L4[5][5][5][5] = 6*dls;
...
std::vector<double> Class_Potential_TRSM::calc_CT() const
{
  ...
  parCT.push_back((v1*HesseWeinberg(3,5) + vs*HesseWeinberg(5,5) - 3*NablaWeinberg(5))/(2.*vs)); //dmsSq;
  parCT.push_back((-(vs*HesseWeinberg(5,5)) + NablaWeinberg(5))/(2.*pow(vs,3))); //dls;
  parCT.push_back(-HesseWeinberg(4,4)); //dmxSq;
  parCT.push_back(0); //dlx;
  parCT.push_back(-(HesseWeinberg(3,5)/(v1*vs))); //dlphis;
...
void Class_Potential_TRSM::SetCurvatureArrays()
{
  ...
  Curvature_Higgs_L2[4][4] = mxSq;
  Curvature_Higgs_L2[5][5] = msSq;
  ...
  Curvature_Higgs_L4[0][0][4][4] = lphix;
  Curvature_Higgs_L4[0][0][5][5] = lphis;
  ...
  Curvature_Higgs_L4[0][4][0][4] = lphix;
  Curvature_Higgs_L4[0][4][4][0] = lphix;
  Curvature_Higgs_L4[0][5][0][5] = lphis;
  Curvature_Higgs_L4[0][5][5][0] = lphis;
  ...
  Curvature_Higgs_L4[1][1][4][4] = lphix;
  Curvature_Higgs_L4[1][1][5][5] = lphis;
  ...
  Curvature_Higgs_L4[1][4][1][4] = lphix;
  Curvature_Higgs_L4[1][4][4][1] = lphix;
  Curvature_Higgs_L4[1][5][1][5] = lphis;
  Curvature_Higgs_L4[1][5][5][1] = lphis;
  ...
  Curvature_Higgs_L4[2][2][4][4] = lphix;
  Curvature_Higgs_L4[2][2][5][5] = lphis;
  Curvature_Higgs_L4[2][3][2][3] = 2*lphi;
  Curvature_Higgs_L4[2][3][3][2] = 2*lphi;
  Curvature_Higgs_L4[2][4][2][4] = lphix;
  Curvature_Higgs_L4[2][4][4][2] = lphix;
  Curvature_Higgs_L4[2][5][2][5] = lphis;
  Curvature_Higgs_L4[2][5][5][2] = lphis;
  ...
  Curvature_Higgs_L4[3][3][4][4] = lphix;
  Curvature_Higgs_L4[3][3][5][5] = lphis;
  Curvature_Higgs_L4[3][4][3][4] = lphix;
  Curvature_Higgs_L4[3][4][4][3] = lphix;
  Curvature_Higgs_L4[3][5][3][5] = lphis;
  Curvature_Higgs_L4[3][5][5][3] = lphis;
  Curvature_Higgs_L4[4][0][0][4] = lphix;
  Curvature_Higgs_L4[4][0][4][0] = lphix;
  Curvature_Higgs_L4[4][1][1][4] = lphix;
  Curvature_Higgs_L4[4][1][4][1] = lphix;
  Curvature_Higgs_L4[4][2][2][4] = lphix;
  Curvature_Higgs_L4[4][2][4][2] = lphix;
  Curvature_Higgs_L4[4][3][3][4] = lphix;
  Curvature_Higgs_L4[4][3][4][3] = lphix;
  Curvature_Higgs_L4[4][4][0][0] = lphix;
  Curvature_Higgs_L4[4][4][1][1] = lphix;
  Curvature_Higgs_L4[4][4][2][2] = lphix;
  Curvature_Higgs_L4[4][4][3][3] = lphix;
  Curvature_Higgs_L4[4][4][4][4] = 6*lx;
  Curvature_Higgs_L4[4][4][5][5] = lsx;
  Curvature_Higgs_L4[4][5][4][5] = lsx;
  Curvature_Higgs_L4[4][5][5][4] = lsx;
  Curvature_Higgs_L4[5][0][0][5] = lphis;
  Curvature_Higgs_L4[5][0][5][0] = lphis;
  Curvature_Higgs_L4[5][1][1][5] = lphis;
  Curvature_Higgs_L4[5][1][5][1] = lphis;
  Curvature_Higgs_L4[5][2][2][5] = lphis;
  Curvature_Higgs_L4[5][2][5][2] = lphis;
  Curvature_Higgs_L4[5][3][3][5] = lphis;
  Curvature_Higgs_L4[5][3][5][3] = lphis;
  Curvature_Higgs_L4[5][4][4][5] = lsx;
  Curvature_Higgs_L4[5][4][5][4] = lsx;
  Curvature_Higgs_L4[5][5][0][0] = lphis;
  Curvature_Higgs_L4[5][5][1][1] = lphis;
  Curvature_Higgs_L4[5][5][2][2] = lphis;
  Curvature_Higgs_L4[5][5][3][3] = lphis;
  Curvature_Higgs_L4[5][5][4][4] = lsx;
  Curvature_Higgs_L4[5][5][5][5] = 6*ls;
...
Class_Potential_TRSM::VTreeSimplified(const std::vector<double> &v) const
{
  ...
  double res = 0;
  res = (pow(v[3],4)*lphi + pow(v[5],4)*ls + pow(v[4],4)*lx + pow(v[3],2)*(pow(v[5],2)*lphis + pow(v[4],2)*lphix + 2*mphiSq) + pow(v[5],2)*(pow(v[4],2)*lsx + 2*msSq) + 2*pow(v[4],2)*mxSq)/4.;
    ...
    const std::vector<double> &v) const
{
  if (not UseVTreeSimplified) return 0;
  double res = 0;
  res = (pow(v[3],4)*dlphi + pow(v[5],4)*dls + pow(v[4],4)*dlx + pow(v[3],2)*(pow(v[5],2)*dlphis + pow(v[4],2)*dlphix + 2*dmphiSq) + pow(v[5],2)*(pow(v[4],2)*dlsx + 2*dmsSq) + 2*pow(v[4],2)*dmxSq)/4. + v[3]*dT4 + v[4]*dT5 + v[5]*dT6;

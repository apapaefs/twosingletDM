...
def dm_exclusion_info(summary, relic_upper_limit, limit_model, rescale):
    return {
        ...
        "dm_indirect_channels_seen": summary.indirect_limit.channels_seen,
        "dm_indirect_channels_used": summary.indirect_limit.channels_used,
...
def empty_dm_exclusion_info():
    return {
        ...
        "dm_indirect_channels_seen": None,
        "dm_indirect_channels_used": None,
